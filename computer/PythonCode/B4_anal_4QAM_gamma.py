...
class Block4(Py_Module):
    ...
    def gamma_av_int(self, complex_var_noise_dB):
        ...
        limvedB = np.array([-np.inf, -10, -5, 3, 20, np.inf])
        poly = [np.nan, [-3.3713e-01, -1.7240, -9.6868], [-4.4671e-04, -9.7377e-04, 7.3512e-02, 4.4928e-01], [7.5883e-05, -4.1892e-03, 8.0807e-02, 4.4374e-01], np.nan]
    ...
    def block4(self, Le, v_e, mi_d, gamma_d):
        ...
        for frame in range(Frames):
            ...
            mi_kb_d_real = self.d4*p_d_kb_[1::self.Q]
            mi_kb_d_imag = self.d4*p_d_kb_[0::self.Q]
