...
class Block4(Py_Module):
    ...
    def gamma_av_int(self, complex_var_noise_dB):
        ...
        limvedB = np.array([-np.inf, -20, -15, -5, 17, np.inf])
        poly = [np.nan, [-0.5297, -12.4614, -90.4311], [1.6432e-03, 5.3705e-02, 4.4139e-01], [8.1335e-06, -2.3058e-04, -2.2228e-04, 5.9839e-02, 4.8486e-01], np.nan]
    ...
    def block4(self, Le, v_e, mi_d, gamma_d):
        ...
        for frame in range(Frames):
            ...
            mi_kb_d_real = self.d16*(2-p_d_kb_[2::self.Q])*p_d_kb_[0::self.Q]
            mi_kb_d_imag = self.d16*(2-p_d_kb_[3::self.Q])*p_d_kb_[1::self.Q]
