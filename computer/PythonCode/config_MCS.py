...
# return [N, Q, X_value, Kb, k_PAM, cstl, matcher_ind, dematcher_ind, cyc_shift, B3_cons, B4_cons]
def get_mcs_config(mcs, fp=0):
    if(mcs == 1):
        N = 256 # Kd
        Q = 2
        ...
        if(fp==0):
            B3_cons = B3_anal_4QAM.Block3
            B4_cons = B4_anal_4QAM.Block4
        else:
            B3_cons = B3_anal_4QAM_fp.Block3
            B4_cons = B4_anal_4QAM_fp.Block4
    elif(mcs == 2):
        N = 256 # Kd
        Q = 2
        X_value = config.X_value_4QAM
        ...
        if(fp==0):
            B3_cons = B3_anal_8PSK_LUT.Block3
            B4_cons = B4_anal_8PSK.Block4
        else:
            B3_cons = B3_anal_8PSK_LUT_fp.Block3
            B4_cons = B4_anal_8PSK_fp.Block4
    elif(mcs == 4):
        N = 384
        Q = 3
        X_value = config.X_value_8PSK_2
        ...
        if(fp==0):
            B3_cons = B3_anal_16QAM.Block3
            B4_cons = B4_anal_16QAM.Block4
        else:
            B3_cons = B3_anal_16QAM_fp.Block3
            B4_cons = B4_anal_16QAM_fp.Block4
    elif(mcs == 6):
        N = 512
        Q = 4
        X_value = config.X_value_16QAM
        ...
        if(fp==0):
            B3_cons = B3_anal_BPSK.Block3
            B4_cons = B4_anal_BPSK.Block4
        else:
            B3_cons = B3_anal_BPSK_fp.Block3
            B4_cons = B4_anal_BPSK_fp.Block4
    elif(mcs == 10):
        N = 128 # Kd
        Q = 1
        X_value = config.X_value_BPSK
